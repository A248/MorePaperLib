...
public class SpigotSchedulingTest extends BukkitSchedulerTestBase {

	public SpigotSchedulingTest(@Mock BukkitScheduler bukkitScheduler, @Mock World world, @Mock Entity entity) {
